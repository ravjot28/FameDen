 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://webservice.fameden.com/", wsdlLocation = "http://puneet-pc:8080/FameDenWS/LoginService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://webservice.fameden.com/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://puneet-pc:8080/FameDenWS/LoginService?wsdl");
     ...
     * 
     * @return
     *     returns LoginServiceContract
     */
    @WebEndpoint(name = "LoginPort")
    public LoginServiceContract getLoginPort() {
        return super.getPort(new QName("http://webservice.fameden.com/", "LoginPort"), LoginServiceContract.class);
    }
     ...
     */
    @WebEndpoint(name = "LoginPort")
    public LoginServiceContract getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.fameden.com/", "LoginPort"), LoginServiceContract.class, features);
    }
