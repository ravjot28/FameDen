 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://login.webservice.fameden.com/", wsdlLocation = "http://puneet-pc:8080/FameDenWS/LoginService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://login.webservice.fameden.com/", "LoginService");
    ...
    public LoginService getLoginPort() {
        return super.getPort(new QName("http://login.webservice.fameden.com/", "LoginPort"), LoginService.class);
    }
     ...
     */
    @WebEndpoint(name = "LoginPort")
    public LoginService getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://login.webservice.fameden.com/", "LoginPort"), LoginService.class, features);
    }
